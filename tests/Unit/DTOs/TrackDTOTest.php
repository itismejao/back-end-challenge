...
class TrackDTOTest extends TestCase
{
    ...
    public function it_creates_a_track_dto_with_all_fields(): void
    {
        $album = new AlbumDTO(
            ...
            externalId: 'album123',
            externalUrl: 'http://spotify.com/album/123',
        ...
        $this->assertSame(1, $dto->discNumber);
        $this->assertSame(3, $dto->trackNumber);
        $this->assertSame('track123', $dto->externalId);
        $this->assertSame('Test Album', $dto->album->name);
        $this->assertCount(1, $dto->artists);
