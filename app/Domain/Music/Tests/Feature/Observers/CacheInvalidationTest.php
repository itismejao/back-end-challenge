...
namespace Music\Tests\Feature\Observers;
...
class CacheInvalidationTest extends TestCase
{
    ...
    {
        $this->populateCache();
        Track::create(['album_id' => $this->album->id, 'isrc' => 'TEST12345678', 'name' => 'Track', 'duration_ms' => 180000, 'explicit' => false, 'disc_number' => 1, 'track_number' => 1]);
    ...
    {
        $track = Track::create(['album_id' => $this->album->id, 'isrc' => 'TEST12345678', 'name' => 'Track', 'duration_ms' => 180000, 'explicit' => false, 'disc_number' => 1, 'track_number' => 1]);
        $this->populateCache();
    ...
    public function track_external_id_created_flushes_cache(): void
    {
        $track = Track::create(['album_id' => $this->album->id, 'isrc' => 'TEST12345678', 'name' => 'Track', 'duration_ms' => 180000, 'explicit' => false, 'disc_number' => 1, 'track_number' => 1]);
        $this->populateCache();
        TrackExternalId::create(['track_id' => $track->id, 'provider_code' => 'spotify', 'external_id' => 'ext123', 'synced_at' => now()]);
        $this->assertCacheFlushed();
    }
    ...
    {
        $track = Track::create(['album_id' => $this->album->id, 'isrc' => 'TEST12345678', 'name' => 'Track', 'duration_ms' => 180000, 'explicit' => false, 'disc_number' => 1, 'track_number' => 1]);
        $externalId = TrackExternalId::create(['track_id' => $track->id, 'provider_code' => 'spotify', 'external_id' => 'ext123', 'synced_at' => now()]);
        $this->populateCache();
